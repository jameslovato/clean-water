...
namespace Drupal\swfwmd\Plugin\views\field;
...
/**
 * Defines a field that links to the user contact page with destination.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("swfwmd_contact_link")
 */
class ContactLink extends LinkBase {
  ...
  protected function getUrlInfo(ResultRow $row) {
    ...
    return Url::fromRoute('entity.user.contact_form', ['user' => $this->getEntity($row)->id()], ['query' => ['destination' => $current_path]]);
  }
