...
/**
 * This plugin provides the target_id of the activity image.
 *
 * @MigrateProcessPlugin(
 *   id = "activity_image"
 * )
 */
class ActivityImage extends ProcessPluginBase {
  ...
  protected function getMediaId($uri) {
    // Create the media.
    $file_id = $this->getUriFileId('public://recreation/activities/' . $uri);
    $media = Media::create([
      'bundle' => 'image',
      'isDefaultRevision' => 1,
      'name' => $uri,
